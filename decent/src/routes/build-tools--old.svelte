...
<script>
    ...
    import BasicSection from '$lib/basicSection.svelte';
    import Ext from '$lib/Ext.svelte';
</script>
...
<article>
    <section class="row">
        <div class="col">
            <nav class="toc">
                ...
                <ul>
                    <li>
                        <a href="#nerdSniping">Nerd Sniping</a>
                        <ul>
                            <li><a href="#weirdState">The (weird) state of build tools</a></li>
                        </ul>
                    </li>
    ...
    <BasicSection title={"Nerd Sniping"} level="2">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/QPZ0pIK_wsc" title="Tom Scott's 'FizzBuzz: One Simple Interview Question'" frameborder="0" allowfullscreen></iframe>
        <p>The other morning I watched a video... and I fully got nerd-sniped.</p>
        ...
        <p>I spent at least an hour on this. <strong>Why?</strong> It's nothing that hasn't been done before (it's probably the most cliché coding challenge you can name).</p>
    ...
    <BasicSection title={"The (weird) state of build tools."} level="3" id="weirdState">
        <p>When people talk about <Ext href="https://css-tricks.com/javascript-fatigue/">JavaScript fatigue</Ext>, at least some part of that is referring to the sometimes painful process of evaluating, learning, and configuring build tools, most of which are both written in, and focussed on managing JS.</p>
    ...
    <BasicSection title={"Problems build tools solve"} level="2" id="problems">
        <img src="/images/problem.svg" alt="" class="body-icon">
    ...
    <BasicSection title={"Categories of build tools"} level="2" id="categories">
        <img src="/images/arrange.svg" alt="" class="body-icon">
    </BasicSection>
    <BasicSection title={"Task runners"} level="3">
    ...
    <BasicSection title={"A list of first-generation task runners"} level="4" id="task-runner-list" further="true">
        <ul>
    ...
    <BasicSection title={"Toolchains"} level="3">
        <figure><img src="/images/2-chainz.jpeg" alt="2 Chainz">
    ...
    <BasicSection further="true" id="toolchain-list" level="4" title="A list of modern JS toolchains:">
        <ul>
    ...
    <BasicSection title={"Bundlers"} level="3">
        <img src="/images/network.svg" alt="" class="body-icon">
    </BasicSection>
    <BasicSection title={"Too many plugins"} level="4">
    ...
    <BasicSection title={"A list of popular bundlers"} level="4" id="bundler-list" further="true">
        <ul>
    ...
    <BasicSection title={"Let's take a build tool for a spin"} level="2" id="try-it">            
        <img src="/images/scooter.svg" alt="" class="body-icon">
...
npm run dev</code></pre>
        ...
        <figure><img src="/images/vite-browser.png" alt="Our starting page in the browser">
    ...
    <BasicSection title={"SASS support in Vite"} level="3" id="sass-vite">
    ...
    <BasicSection title={"Module bundling in Vite"} level="3" id="module-vite">
    ...
    <BasicSection title={"Building for production"} level="3" id="prod">
    ...
    <BasicSection title={"Previewing production"} level="3" id="preview">
...
npm run preview</code></pre>
    ...
    <BasicSection title={"Et cetera."} level="3">
